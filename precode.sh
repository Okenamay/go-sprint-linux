...
touch dir2/list.txt && find dir2 -type f > dir2/list.txt 
# копируем содержимое каталога task/dir2 в каталог task/dir3/dir4
find dir2 -exec cp {} dir3/dir4 \;
# записываем в task/dir1/summary.txt список файлов с расширением *.txt
# находящихся в task, включая поддиректории
touch dir1/summary.txt && find . -name "*.txt" > dir1/summary.txt
...
touch 'Практическое задание' && cp dir1/summary.txt 'Практическое задание' && rm dir1/summary.txt
