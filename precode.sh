...
mkdir task && mkdir task/dir{1..3} && mkdir -p task/dir3/dir4
...
echo '#!/bin/bash'> dir2/hello.sh && echo 'echo "$1, привет!" '>> dir2/hello.sh
...
find -name "*.txt" -exec echo {} > dir1/summary.txt \;
